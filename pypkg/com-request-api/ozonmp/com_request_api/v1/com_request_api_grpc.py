...
class ComRequestApiServiceBase(abc.ABC):
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/denlipov.com_request_api.v1.ComRequestApiService/UpdateRequestV1': grpclib.const.Handler(
...
class ComRequestApiServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.UpdateRequestV1 = grpclib.client.UnaryUnaryMethod(
            channel,
            '/denlipov.com_request_api.v1.ComRequestApiService/UpdateRequestV1',
            ozonmp.com_request_api.v1.com_request_api_pb2.UpdateRequestV1Request,
            ozonmp.com_request_api.v1.com_request_api_pb2.UpdateRequestV1Response,
        )
